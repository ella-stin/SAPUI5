		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzui51308-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzui51308-display": {
								"semanticObject": "iitpzui51308",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zui51308",
									"url": sap.ui.require.toUrl("iitp/zui51308")
								}
							}
						}
					}
